...
<td width="35%"><?php echo $objResult["Address"];?></td>
<td width="15%"><?php echo $objResult["Tel"];?></td>
<td width="15%"><?php echo $objResult["Email"];?></td>
 
</tr>
  </table>

<center>
<table width="400"  border="1" class="w3-table-all">
<thead>
  <tr class="w3-hover-black">
    <th width="200">Order</td>
    <th>ProductName</td>
    <th>Price</td>
    <th>Quantity</td>
    <th>Total</td>
...
$objResult = mysql_fetch_array($objQuery);
 ...
 <td></td><td></td><td></td><td>Charge</td><td><?php echo number_format($objResult['charge'],2);?></td>
 </tr>
 <tr class="w3-hover-red">
 <td></td><td></td><td></td>
 <td>
