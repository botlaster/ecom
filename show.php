...
<table class="abc" width="700"  border="1" id="customers">
  ...
  <tr>
		...
		<td><?php if($count>0){$_SESSION["c"]=($count-1)*10+50;echo number_format($_SESSION["c"],2);}?></td>
		<td></td>
	  </tr>
  <tr>
		<td><strong></strong></td>
		...
		<td><?php $_SESSION['sum']=$SumTotal+$_SESSION["c"]; echo number_format($_SESSION['sum'],2);?></td>
		<td></td>
	  </tr>
</table>
...
<!-- <table width="100%" border="0">
  ...
  <td width="12%" align=center> <?php echo '$'.number_format($SumTotal,0);?></td>
  <td width="6%" ><input class="button button2" type="submit" value="Update"/></td>
  </tr>
  <tr>
  <td width="30%"><strong>ค่าส่งชิ้นแรกราคา 50 บาท ตั้งแต่ชิ้นที่ 2 ขึ้นไปชิ้นละ 10 บาท</strong> </td>
  <td width="40%" align=right>Quantity:</td>
  ...
  <?php
	...
	{
?>
	 <button class="button button3" id="abc" onclick="location='checkout.php'">Payment</button> 
<?php
	}
mysql_close();
?>
