...
if(isset($_POST['order']))
{
	...
	while($objResult2 = mysql_fetch_array($objQuery2))
	{
		  ...
		  <tr class="w3-hover-blue">
			...
			<td><?php echo "<img src='admin/product/".$objResult3['filename']."' height=150/>" ?></td>
...
else
{
	...
	$strSQL = "SELECT * FROM orders WHERE Email = '".$_POST["email"]."' ";
	$objQuery = mysql_query($strSQL)  or die(mysql_error());
	$objResult = mysql_fetch_array($objQuery);
	if($objResult=="")
	{
		?>
		<p style="margin-top:150;margin-bottom:150; font-size:40" align=center>This email does not exist Or No Order.</p>
		<?php
	}
	else
	{
